...
- **`frontend-design` skill** at [frontend-design](file:///Users/arnie/.gemini/config/plugins/modern-web-guidance-plugin/skills/frontend-design/SKILL.md) — read this before building any web UI. It encodes design tokens, component patterns, and styling constraints specific to this environment. Loading it is not optional for design work.
